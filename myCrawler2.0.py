# th3xer0's  Web Crawler - 4.0
# Usage:
# index = crawl_web('seed_url')
# index = crawl_web('http://www.dtctechnology.com')
...
def crawl_web(seed):
    tocrawl = [seed] #populate tocrawl list with seed url
    crawled = []
    index = [] #initialize index - blank
    while tocrawl:
        page = tocrawl.pop() #set page to last url in tocrawl list, remove from list
